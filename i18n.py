...
STRINGS = {
    "en": {
        ...
        "v_listening": "🎧 Listening… play the stream you want translated",
        "v_lang": "My language",
        "v_showorig": "Show original text",
        "v_size": "Text size",
        "v_size_s": "Small",
        "v_size_m": "Medium",
        "v_size_l": "Large",
        "v_device": "Audio source",
        "v_device_default": "Default speakers",
        "v_ocr_on": "Translate screen text (beta)",
        "v_ocr_off": "Stop screen translation",
        "v_ocr_hint": "Drag a box over the text to translate — Esc to cancel",
        "v_ocr_nohit": "No text recognized here — for Japanese, Korean, Chinese… add that language in Windows Settings → Language",
        "v_quit": "Close viewer mode",
    ...
    "pt": {
        ...
        "v_listening": "🎧 Ouvindo… dê play na stream que você quer traduzir",
        "v_lang": "Meu idioma",
        "v_showorig": "Mostrar texto original",
        "v_size": "Tamanho do texto",
        "v_size_s": "Pequeno",
        "v_size_m": "Médio",
        "v_size_l": "Grande",
        "v_device": "Fonte de áudio",
        "v_device_default": "Alto-falantes padrão",
        "v_ocr_on": "Traduzir texto da tela (beta)",
        "v_ocr_off": "Parar tradução da tela",
        "v_ocr_hint": "Arraste uma caixa sobre o texto a traduzir — Esc cancela",
        "v_ocr_nohit": "Nenhum texto reconhecido aqui — para japonês, coreano, chinês… adicione o idioma em Configurações do Windows → Idioma",
        "v_quit": "Fechar modo espectador",
    ...
    "he": {
        ...
        "v_listening": "🎧 מאזין… הפעל את השידור שברצונך לתרגם",
        "v_lang": "השפה שלי",
        "v_showorig": "הצג טקסט מקורי",
        "v_size": "גודל טקסט",
        "v_size_s": "קטן",
        "v_size_m": "בינוני",
        "v_size_l": "גדול",
        "v_device": "מקור שמע",
        "v_device_default": "רמקולי ברירת מחדל",
        "v_ocr_on": "תרגום טקסט מהמסך (בטא)",
        "v_ocr_off": "עצור תרגום מסך",
        "v_ocr_hint": "גרור מסגרת סביב הטקסט לתרגום — Esc לביטול",
        "v_ocr_nohit": "לא זוהה טקסט — ליפנית, קוריאנית, סינית… הוסף את השפה בהגדרות Windows ← שפה",
        "v_quit": "סגור מצב צופה",
    ...
    "pl": {
        ...
        "v_listening": "🎧 Słucham… włącz stream, który chcesz przetłumaczyć",
        "v_lang": "Mój język",
        "v_showorig": "Pokaż oryginalny tekst",
        "v_size": "Rozmiar tekstu",
        "v_size_s": "Mały",
        "v_size_m": "Średni",
        "v_size_l": "Duży",
        "v_device": "Źródło dźwięku",
        "v_device_default": "Domyślne głośniki",
        "v_ocr_on": "Tłumacz tekst z ekranu (beta)",
        "v_ocr_off": "Zatrzymaj tłumaczenie ekranu",
        "v_ocr_hint": "Przeciągnij ramkę nad tekstem do przetłumaczenia — Esc anuluje",
        "v_ocr_nohit": "Nie rozpoznano tekstu — dla japońskiego, koreańskiego, chińskiego… dodaj ten język w Ustawieniach Windows → Język",
        "v_quit": "Zamknij tryb widza",
    ...
    "ja": {
        ...
        "p_viewer_row": "配信の翻訳",
        "v_listening": "🎧 聞き取り中… 翻訳したい配信を再生してください",
        "v_lang": "自分の言語",
        "v_showorig": "原文を表示",
        "v_size": "文字サイズ",
        "v_size_s": "小",
        ...
        "v_size_l": "大",
        "v_device": "音声ソース",
        "v_device_default": "既定のスピーカー",
        "v_ocr_on": "画面のテキストを翻訳（ベータ）",
        "v_ocr_off": "画面翻訳を停止",
        "v_ocr_hint": "翻訳したいテキストを囲むようにドラッグ — Escでキャンセル",
        "v_ocr_nohit": "テキストを認識できません — 日本語・韓国語・中国語などはWindows設定→言語でその言語を追加してください",
        "v_quit": "視聴者モードを終了",
        "p_copyerr": "エラーをコピー 📋",
    ...
    "zh": {
        ...
        "v_size_l": "大",
        "v_device": "音频来源",
        "v_device_default": "默认扬声器",
        "v_ocr_on": "翻译屏幕文字（测试版）",
        "v_ocr_off": "停止屏幕翻译",
        "v_ocr_hint": "拖动框选要翻译的文字 — 按 Esc 取消",
        "v_ocr_nohit": "未识别到文字 — 日语、韩语、中文等请在 Windows 设置 → 语言 中添加该语言",
        "v_quit": "退出观众模式",
        "p_copyerr": "复制错误 📋",
    ...
    "ko": {
        ...
        "p_viewer_row": "방송 번역",
        "v_listening": "🎧 듣는 중… 번역할 방송을 재생하세요",
        "v_lang": "내 언어",
        "v_showorig": "원문 표시",
        "v_size": "글자 크기",
        "v_size_s": "작게",
        ...
        "v_size_l": "크게",
        "v_device": "오디오 소스",
        "v_device_default": "기본 스피커",
        "v_ocr_on": "화면 텍스트 번역 (베타)",
        "v_ocr_off": "화면 번역 중지",
        "v_ocr_hint": "번역할 텍스트 위로 드래그하세요 — Esc 취소",
        "v_ocr_nohit": "텍스트를 인식하지 못했습니다 — 일본어·한국어·중국어 등은 Windows 설정 → 언어에서 해당 언어를 추가하세요",
        "v_quit": "시청자 모드 종료",
        "p_copyerr": "오류 복사 📋",
    ...
    "es": {
        ...
        "v_listening": "🎧 Escuchando… reproduce el stream que quieres traducir",
        "v_lang": "Mi idioma",
        "v_showorig": "Mostrar texto original",
        "v_size": "Tamaño del texto",
        "v_size_s": "Pequeño",
        "v_size_m": "Mediano",
        "v_size_l": "Grande",
        "v_device": "Fuente de audio",
        "v_device_default": "Altavoces predeterminados",
        "v_ocr_on": "Traducir texto en pantalla (beta)",
        "v_ocr_off": "Detener traducción de pantalla",
        "v_ocr_hint": "Arrastra un recuadro sobre el texto a traducir — Esc cancela",
        "v_ocr_nohit": "No se reconoció texto aquí — para japonés, coreano, chino… añade ese idioma en Configuración de Windows → Idioma",
        "v_quit": "Cerrar modo espectador",
